...
| `sistema_empleados/empleado.py` | Clase Empleado con atributos y comportamientos |
| `sistema_empleados/empresa.py` | Clase Empresa que gestiona empleados |
